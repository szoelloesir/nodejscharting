...
class ChartJSNodeCanvas {
    ...
    initialize(options) {
        ...
        if ((_c = options.plugins) === null || _c === void 0 ? void 0 : _c.modern) {
            for (const plugin of options.plugins.modern) {
                if (typeof plugin === 'string') {
                    auto_1.Chart.register((0, freshRequire_1.freshRequire)(plugin));
                }
                else {
        ...
        if (options.backgroundColour) {
            auto_1.Chart.register(new backgroundColourPlugin_1.BackgroundColourPlugin(options.backgroundColour));
        }
    ...
    renderChart(configuration) {
        ...
        const chart = new auto_1.Chart(context, configuration);
        delete global.Image;
        return chart;
    }
}
